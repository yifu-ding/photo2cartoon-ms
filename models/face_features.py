...
class FaceFeatures(object):
    ...
    def infer(self, batch_tensor):
        ...
        # bilinear = nn.ResizeBilinear()
        # batch_tensor = bilinear(batch_tensor, size=[112, 112], mode='bilinear', align_corners=True)
    ...
    def cosine_distance(self, batch_tensor1, batch_tensor2):
        batch_tensor1 = torch.Tensor(batch_tensor1.asnumpy()).cuda()
        batch_tensor2 = torch.Tensor(batch_tensor2.asnumpy()).cuda()
